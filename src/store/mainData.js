...
export const useMainDataStore = defineStore('mainData', () => {
	...
	const tariffs = ref([
		{ title: 'Без обратной связи', price: '8 900 ₽', text: 'Доступ ко всем видеоурокам + сертификат', link: '#' },
		{ title: 'С поддержкой', price: '10 900 ₽', text: 'Уроки, сертификат и обратная связь по 5 работам', link: '#' }
	])
	const images = ref([
  		{ src: work2 },
  		{ src: work3 },
