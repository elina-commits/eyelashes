...
import work6 from '@/assets/images/eyelashes__works-img6.jpg';
import work7 from '@/assets/images/eyelashes__works-img7.jpg';
...
export const useMainDataStore = defineStore('mainData', () => {
	...
	const tariffs = ref([
		{ title: 'Корейское ламинирование', subtitle: 'Без обратной связи', price: '8 900 ₽', text: 'Доступ ко всем видеоурокам + сертификат', link: '/payment' },
		{ title: 'Корейское ламинирование', subtitle: 'С поддержкой', price: '10 900 ₽', text: 'Уроки, сертификат и обратная связь по 5 работам', link: '/payment' },
		{ title: 'Корейское ламинирование', subtitle: 'С поддержкой', price: '10 900 ₽', text: 'Уроки, сертификат и обратная связь по 5 работам', link: '/payment' },
		{ title: 'Корейское ламинирование', subtitle: 'С поддержкой', price: '10 900 ₽', text: 'Уроки, сертификат и обратная связь по 5 работам', link: '/payment' },
		{ title: 'Корейское ламинирование', subtitle: 'С поддержкой', price: '10 900 ₽', text: 'Уроки, сертификат и обратная связь по 5 работам', link: '/payment' },
		{ title: 'Корейское ламинирование', subtitle: 'С поддержкой', price: '10 900 ₽', text: 'Уроки, сертификат и обратная связь по 5 работам', link: '/payment' },
  ...
  return { items, contacts, parts, tariffs, images, cards, reviews }
})